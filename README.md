...
`@cndllabs/v3-periphery`
and import bytecode imported from artifacts located at
`@cndllabs/v3-periphery/artifacts/contracts/*/*.json`.
For example:
...
} from '@cndllabs/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
via the npm artifact `@cndllabs/v3-periphery`, e.g.:

```solidity
import '@cndllabs/v3-periphery/contracts/interfaces/ISwapRouter.sol';
